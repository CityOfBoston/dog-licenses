...
import { LICENSE_COST, PROCESSING_FEE } from '../store/Cart';
...
export default class PaymentPage extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <Head>
          <title>Boston.gov — Dog License Payment</title>
        </Head>
          ...
          <button className="sel-c sel-c--fw" type="button">
            <div className="sel-f">
              ...
              <div className="t--info">
                {cart.size} {cart.size === 1 ? 'license' : 'licenses'} ×
                ${LICENSE_COST} + fee = ${cart.cost.toFixed(2)}
              </div>
            </div>
          </button>
  ...
  renderCost() {
    ...
    return (
      <div className="m-v500 g--9">
        <div className="t--info">
          {cart.size} {cart.size === 1 ? 'license' : 'licenses'} × ${LICENSE_COST}{' '}
